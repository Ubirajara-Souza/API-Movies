...
{
    public partial class CreateTablesGeneral : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cinema_Endereco_AddressID",
                        column: x => x.AddressID,
                        principalTable: "Endereco",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cinema_Gerente_ManagerID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sessao_Cinema_MovieTheaterID",
                        column: x => x.MovieTheaterID,
                        principalTable: "Cinema",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sessao_Filme_MovieID",
                        column: x => x.MovieID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cinema_ManagerID",
                table: "Cinema",
                column: "ManagerID");

            migrationBuilder.CreateIndex(
                name: "IX_Sessao_MovieID",
                table: "Sessao",
                column: "MovieID");

            migrationBuilder.CreateIndex(
                name: "IX_Sessao_MovieTheaterID",
                table: "Sessao",
